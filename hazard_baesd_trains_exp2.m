...
clear
load('C:\Users\Owner\Google Drive\Roy- experiments\checkerMicSac\dark_ms_v3\sp_c_train.mat')

cnt=0;pdfs=zeros(12,5000);
figure;
for snum=[1:12]
    cnt=cnt+1; 
...
for snum=[1:12]
    ...
    %spikeTrain=remove_breaks_from_spike_trains( trace,10000);
